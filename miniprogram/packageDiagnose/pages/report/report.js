...
const { unescapeUnderscore } = require('../../utils/latex');
const app = getApp();
...
Page({
  ...
  // ============ 跳转单题详情 ============
  openDetail(e) {
    const qid = e.currentTarget.dataset.id || e.currentTarget.dataset.qid;
    if (!qid) return;
    wx.navigateTo({ url: '/packageDiagnose/pages/question-detail/question-detail?questionId=' + qid });
  },
